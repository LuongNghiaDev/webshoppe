...
<head>
    ...
    <link rel="stylesheet" href="<c:url value='/assets/admin/assets/css/bootstrap.min.css' />" />
    <link rel="stylesheet" href="<c:url value='/assets/admin/font-awesome/4.5.0/css/font-awesome.min.css' />" />
    <link rel="stylesheet" href="<c:url value='/assets/admin/assets/css/ace.min.css' />" class="ace-main-stylesheet" id="main-ace-style" />
    <script src="<c:url value='/assets/admin/assets/js/ace-extra.min.js' />"></script>
...
<script src="<c:url value='/assets/admin/paging/jquery.twbsPagination.js' />"></script>
